      ...
      <div style={{ padding: "0 clamp(20px, 4vw, 32px) 72px", maxWidth: 1280, margin: "0 auto" }}>
        ...
        {list.length > 0 && (
          <div className="rv" style={{ marginBottom: 14, position: "relative", borderRadius: 28, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", aspectRatio: "21/9", minHeight: 300, background: "#141414" }}>
            ...
            <div style={{ position: "absolute", left: "clamp(20px, 4vw, 40px)", right: "clamp(20px, 4vw, 40px)", bottom: "clamp(20px, 3vw, 36px)" }}>
              ...
              <div className="display" style={{ fontSize: "clamp(1.8rem, 4vw, 3.6rem)" }}>{list[0][2]}</div>
              <div className="mono-label" style={{ marginTop: 12 }}>By {list[0][3]} · ✔ Accredited</div>
            </div>
          </div>
        )}
        ...
        <div className="glass rv" style={{ marginTop: 56, padding: "clamp(24px, 4vw, 40px)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 24 }}>
          <div>
            ...
            <p style={{ margin: "10px 0 0", font: '400 15px/1.6 var(--font-inter-tight), sans-serif', color: "rgba(255,255,255,0.6)", maxWidth: 480 }}>
